...
public class FinalDNSClientSocket {
	Socket clientSocket;
	String ipAddress;
	int port = 6459;
	...
	public void resolveHostName(String hostName) throws Exception {
		...
		System.out.println("host name sent to  Final server socket as :" + hostName);
	}
	...
	public String receiveIpFromServerSocket() throws Exception {
		...
		clientSocket.close();
		System.out.println("Ip address recieved from Final server socket as " + ipAddress);
		return ipAddress;
	}
}
